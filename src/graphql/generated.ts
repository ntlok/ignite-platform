...
export type CreateSubscriberUserMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreateSubscriberUserMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CreateSubscriberUserDocument = gql`
    mutation CreateSubscriberUser($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CreateSubscriberUserMutationFn = Apollo.MutationFunction<CreateSubscriberUserMutation, CreateSubscriberUserMutationVariables>;

/**
 * __useCreateSubscriberUserMutation__
 *
 * To run a mutation, you first call `useCreateSubscriberUserMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSubscriberUserMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSubscriberUserMutation, { data, loading, error }] = useCreateSubscriberUserMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSubscriberUserMutation(baseOptions?: Apollo.MutationHookOptions<CreateSubscriberUserMutation, CreateSubscriberUserMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSubscriberUserMutation, CreateSubscriberUserMutationVariables>(CreateSubscriberUserDocument, options);
      }
export type CreateSubscriberUserMutationHookResult = ReturnType<typeof useCreateSubscriberUserMutation>;
export type CreateSubscriberUserMutationResult = Apollo.MutationResult<CreateSubscriberUserMutation>;
export type CreateSubscriberUserMutationOptions = Apollo.BaseMutationOptions<CreateSubscriberUserMutation, CreateSubscriberUserMutationVariables>;
